...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="bg-muted/50 py-12 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="mt-3 text-muted-foreground">
                Simplifying club management for administrators everywhere.
              </p>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-muted-foreground/20 flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm">
              © {new Date().getFullYear()} ClubPulse. All rights reserved.
            </p>
